---
type: feature
title: Bike (codex) — live sanitized usage overview
description: The smallest complete codex-proxy outcome: transparent forwarding and live token and cost visibility.
...
Bike reaches the destination with one safe loop: Codex traffic still reaches its configured OpenAI upstream, and
...
[ADR 0019](../adrs/0019-sanitized-audit-sidecars.md),
[ADR 0020](../adrs/0020-unavailable-incomplete-cost.md), and
...
[ADR 0022](../adrs/0022-fresh-repository-history.md) and
[ADR 0023](../adrs/0023-private-github-publication.md). Runtime secrets and data stay untracked regardless of
