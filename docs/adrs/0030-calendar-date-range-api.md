...
provenance:
  - repo: codex-proxy
    number: "0011"
    file: docs/adrs/0011-calendar-date-range-api.md
decided-by: /dev
ratified: false
...
Inherited from `codex-proxy` `docs/adrs/0011-calendar-date-range-api.md` (`codex#0011`) and
renumbered to 0030 when the three corpora were merged into this bundle during the
