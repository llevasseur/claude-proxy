...
provenance:
  - repo: ox-alpha-proxy
    number: "0013"
    file: docs/adrs/0013-fable-standin-rates-for-ox-alpha.md
decided-by: /god
ratified: false
...
[ADR 0033](0033-meter-chat-completions-usage.md) makes Ox Alpha
...
[ADR 0020](0020-unavailable-incomplete-cost.md) requires that an unknown model
...
- Replace this entry with real rates the moment zen publishes them, or drop it
  and let cost read unavailable per ADR 0020 — that outcome is honest and
  remains the correct default for any model without a published price.

## Provenance

Inherited from `ox-alpha-proxy` `docs/adrs/0013-fable-standin-rates-for-ox-alpha.md` (`ox-alpha#0013`) and
renumbered to 0035 when the three corpora were merged into this bundle during the
