    ...
    <section>
      ...
      <div className='card' style={{ marginBottom: 16 }}>
        <div className='leak-note'>
          ...
          setting will keep it out: withheld tools are exempt from <span className='rule-name'>permissions.deny</span>,
          and injected reminders have no suppression setting at all. Requests with nothing to strip are forwarded
          byte-for-byte.
        </div>
      </div>
