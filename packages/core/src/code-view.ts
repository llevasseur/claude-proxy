...
const KEYWORDS: Record<CodeSyntax, ReadonlySet<string>> = {
  "c-like": new Set([
    ...
    "readonly", "return", "satisfies", "static", "super", "switch", "this", "throw", "true", "try", "type",
    "typeof", "undefined", "var", "void", "while", "yield",
  ]),
  hash: new Set([
    "and", "as", "break", "case", "class", "continue", "def", "do", "done", "elif", "else", "esac", "export",
    "false", "fi", "for", "from", "function", "if", "import", "in", "lambda", "local", "None", "not", "or",
    "pass", "raise", "return", "self", "set", "source", "then", "true", "True", "False", "unset", "while", "with",
  ]),
